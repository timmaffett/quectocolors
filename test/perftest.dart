...
enum TestLevels { simple, simple_3styles, complex, largerandom_complex }
...
void main() async {
  ...
  print(
    centerStrOnTerminal('QuectoColors Performance Testing Suite', consoleWidth),
  );
  print('');
  print('');
...
void runTests(TestLevels testMode, int consoleWidth) {
  if (consoleWidth < 80)
    consoleWidth = 80; // Make the charts minimum of 80 chars wide
  ...
  final random = Random();
  final randomBigString = List.generate(
    200,
  ...
  print(
    'QuectoColorsStatic (accessing Static methods directly) performance test:'
        .blue,
  );
  print('Iterations: $iterations');
  print('Total time: ${stopwatch0.elapsedMilliseconds} ms');
  print(
    'Average time per iteration: ${stopwatch0.elapsedMilliseconds / iterations} ms',
  );
  ...
  print(
    'Average time per iteration: ${stopwatch1.elapsedMilliseconds / iterations} ms',
  );
  final timeQuectoColors = stopwatch1.elapsedMilliseconds / iterations;

  double percent_1div0 =
      stopwatch1.elapsedMilliseconds / stopwatch0.elapsedMilliseconds;
  double percent_0div1 =
      stopwatch0.elapsedMilliseconds / stopwatch1.elapsedMilliseconds;

  print(
    'PERCENT diff    QuectoColors Instance/QuectoColorsStatic = ${(percent_1div0 * 100.0).toStringAsFixed(2)}%  (<100% means faster)  QuectoColorsStatic/quectoColorsInstance =${(percent_0div1 * 100.0).toStringAsFixed(2)}%'
        .blueBright,
  );

  // AFTER we have static and instance now make the percent chart
  String nameFormatted = AsciiChart.namePaddedToLength(
    'QuectoColorsStatic',
    20,
  );
  ...
  final stopwatch2 = Stopwatch()..start();
  {
    ...
    for (var i = 0; i < iterations; i++) {
      ...
      switch (testMode) {
        case TestLevels.largerandom_complex:
          String testThisStr =
              'This is our string to test $i' + randomBigString;
          String innerString2 = "inner $i str" + randomBigString;
  ...
  print(
    'Average time per iteration: ${stopwatch2.elapsedMilliseconds / iterations} ms',
  );
  final timeAnsiOrig = stopwatch2.elapsedMilliseconds / iterations;
  double percent_2div1 =
      stopwatch2.elapsedMilliseconds / stopwatch1.elapsedMilliseconds;

  double percent_1div2 =
      stopwatch1.elapsedMilliseconds / stopwatch2.elapsedMilliseconds;

  print(
    'PERCENT diff    ansicolors/quectocolors = ${(percent_2div1 * 100.0).toStringAsFixed(2)}%  (<100% means faster)  quectocolors/ansicolors =${(percent_1div2 * 100.0).toStringAsFixed(2)}%'
        .blueBright,
  );
  ...
  print(
    'Average time per iteration: ${stopwatch3.elapsedMilliseconds / iterations} ms',
  );
  final timeQuectoStrings = stopwatch3.elapsedMilliseconds / iterations;

  double percent_3div1 =
      stopwatch3.elapsedMilliseconds / stopwatch1.elapsedMilliseconds;
  double percent_1div3 =
      stopwatch1.elapsedMilliseconds / stopwatch3.elapsedMilliseconds;

  double percent_3div2 =
      stopwatch3.elapsedMilliseconds / stopwatch2.elapsedMilliseconds;
  double percent_2div3 =
      stopwatch2.elapsedMilliseconds / stopwatch3.elapsedMilliseconds;

  print(
    'PERCENT diff    quecto strings/quectocolors = ${(percent_3div1 * 100.0).toStringAsFixed(2)}%  (<100% means faster)  quectocolors/quecto strings = ${(percent_1div3 * 100.0).toStringAsFixed(2)}%'
        .blueBright,
  );
  print(
    'PERCENT diff    quecto strings/ANSICOLORS = ${(percent_3div2 * 100.0).toStringAsFixed(2)}%  (<100% means faster)   ANSICOLORS/quecto strings = ${(percent_2div3 * 100.0).toStringAsFixed(2)}%'
        .cyan,
  );
  ...
  stopwatch4.stop();
  print(
    '\nBuilt in USING ANSICOLORS compatible AnsiPen performance test:'
        .greenBright,
  );
  print('Iterations: $iterations');
  print('Total time: ${stopwatch4.elapsedMilliseconds} ms');
  print(
    'Average time per iteration: ${stopwatch4.elapsedMilliseconds / iterations} ms',
  );
  final timeQuectoAni = stopwatch4.elapsedMilliseconds / iterations;

  double percent_2div4 =
      stopwatch2.elapsedMilliseconds / stopwatch4.elapsedMilliseconds;

  double percent_4div2 =
      stopwatch4.elapsedMilliseconds / stopwatch2.elapsedMilliseconds;

  double percent_4div1 =
      stopwatch4.elapsedMilliseconds / stopwatch1.elapsedMilliseconds;

  print(
    'PERCENT diff    ansicolors/quectoANSI = ${(percent_2div4 * 100.0).toStringAsFixed(2)}%  (<100% means faster)  quectoANSI/ansicolors =${(percent_4div2 * 100.0).toStringAsFixed(2)}%'
        .blueBright,
  );
  ...
  print(
    'Average time per iteration: ${stopwatch5.elapsedMilliseconds / iterations} ms',
  );
  final timeChalkDart = stopwatch5.elapsedMilliseconds / iterations;

  double percent_2div5 =
      stopwatch2.elapsedMilliseconds / stopwatch5.elapsedMilliseconds;
  double percent_5div2 =
      stopwatch5.elapsedMilliseconds / stopwatch2.elapsedMilliseconds;

  print(
    'PERCENT diff    ansicolors/ChalkDart = ${(percent_2div5 * 100.0).toStringAsFixed(2)}%  (<100% means faster)  ChalkDart/ansicolors =${(percent_5div2 * 100.0).toStringAsFixed(2)}%'
        .blueBright,
  );

  double percent_5div1 =
      stopwatch5.elapsedMilliseconds / stopwatch1.elapsedMilliseconds;
  double percent_1div5 =
      stopwatch1.elapsedMilliseconds / stopwatch5.elapsedMilliseconds;

  print(
    'PERCENT diff    quectocolors/ChalkDart = ${(percent_5div1 * 100.0).toStringAsFixed(2)}%  (<100% means faster)  ChalkDart/quectocolors = ${(percent_1div5 * 100.0).toStringAsFixed(2)}%'
        .blueBright,
  );
  ...
  double maxTime =
      findMax(timePerIterationList) *
      1000000.0; // convert milliseconds to nanoseconds
