...
/* WAY 3 - THIS IS slightly slower than MAIN WAY, faster than WAY2 */
    final sb = StringBuffer();
...
/* END WAY 4 */
  ...
  /// Example: quectoColorsAlt.plain.red('Hello World')
...
QuectoColorsAlt quectoColorsAlt = QuectoColorsAlt();